...
export function detectTags(title: string, summary: string): ArticleTag[] {
  ...
  const checks: [string[], ArticleTag][] = [
    ...
    [['signed to', 'signed a', 'signs with', 'signing with',
       'agrees to terms', 'agree to terms', 'free agent signing',
       'ink a deal', 'inked a deal', 'one-year deal', 'two-year deal',
       'three-year deal', 'multi-year deal'],                      'signing'],
    [['released', 'waived', 'cuts ', 'has cut', 'parting ways'],  'release'],
